...
# to run not headless, will have a step through
# PWDEBUG=1 pytest
# to run tests containing text of "create"
# pytest -k "create"
# run tests in parallel
# pip install pytest-xdist
# pytest -n auto

# live_server - runserver, browser sets up a live browser, think selenium
...
class TestDelete:
    ...
    # this decorator allows db access for test. could be in parameter but then it's an unused parameter.
    @pytest.mark.django_db
    def test_non_author(self, client, user_factory, blog_post):
        client.force_login(user_factory())
